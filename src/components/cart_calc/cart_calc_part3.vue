    ...
    <div class="outer">
        <div class="container-xl body">
            <div class="notification">
                <i class="fa fa-check hook" aria-hidden="true" v-if="proceeded"></i>
                <div class="order_info clearfix">
                    <div class="left">
                        <h2 v-if="!proceeded">订单处理中，请稍候……</h2>
                        <h2 v-if="proceeded && !finalStatus">订单提交成功！</h2>
                        <h2 v-if="finalStatus">订单处理完毕！</h2>
                        <p v-if="!expanding && finalStatus">收货信息：{{ clientname }}
                            {{ phonenum }}
                    ...
                    <div class="right" v-if="finalStatus">
                        <div class="total">
                            支付金额：
                ...
                <div class="details" :class="{ 'myhidden': !expanding }" v-if="finalStatus">
                    <ul>
                        <li class="clearfix">
                            <label for="">订单号：</label>
                            <div class="content">
...
export default {
    ...
    data() {
        return {
            ...
            order_overhead: 0,
            expanding: false,
            finalStatus: false,//true为处理完毕，false为仍在处理中
            proceeded: false,
            plist: []
        }
    },
