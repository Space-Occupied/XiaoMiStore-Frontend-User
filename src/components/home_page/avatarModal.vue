<template>
    <b-modal id="avatarModal" centered hide-footer v-model="show_modal">
        <template #header>
            <button @click="myClose" style="z-index: 10000;">
...
export default {
    name: 'avatarModal',
    computed: {
        ...mapState(['avatar_path','location_prefix','avatar_modal']),
        computed_path() {
    ...
    watch: {
        ...
        show_modal: {
            handler(newValue, oldValue) {
                if (!newValue) {
                    this.$store.commit('avatar_modal', false);
                }
            }
        }
    },
        ...
        loadingImg(eve) {
            ...
            if (eve.target.files[0]) {
                ...
                reader.onload = (e) => {
                    ...
                    // console.log(this.myCropper.destory);
