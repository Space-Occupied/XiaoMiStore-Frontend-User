<template>
  <div>
    <b-modal id="myModal" centered v-model="show_modal">
      ...
      <div class="row mt-1">
        ...
        <div class="col-9">
          ...
          <b-alert class="p-1" variant="danger" :model-value="id.length && !id_legal">
      ...
      <div class="row mt-1">
        ...
        <div class="col-9">
          <div class="input-group w-100">
            ...
            <b-alert class="p-1" variant="danger" :model-value="password.length && !password_legal">
              <i class="fa fa-exclamation-circle" aria-hidden="true"></i>
      ...
      <div v-if="$store.state.modal === 2" class="row mt-1">
        ...
        <div class="col-9">
          <div class="input-group w-100">
            ...
            <b-alert class="p-1" variant="danger" :model-value="password.length &&
              repassword.length &&
              (
...
<!-- <script setup>
  ...
  let repassword = ''
  let loading = false
  let disp_loading = false
  let disp_success = false
  let disp_failure = false
  let psw_vis = false
...
export default {
  ...
  computed: {
    ...
    ...mapState(['location_prefix', 'userid', 'modal'])
  },
  methods: {
