    ...
    <div>
        ...
        <div class="product_header mb-5">
            <div class="container-xl">
                <div class="row mb-1">
                    <div class="col-md-6">
                        <h2 class="m-0">{{ this.pname ? this.pname : this.$route.query.pname }}</h2>
                    </div>
                    <div class="col-md-6">
                        <ul>
                            <li><a>概述</a></li>
...
import verify_token from '@/assets/js/verify_token_old';
...
export default {
    ...
    watch: {
        ...
        //             // debugger
        //             console.log("9983948938378978892792");
    ...
    methods: {
        ...
        reload() {
            ...
            fetch(this.$store.state.location_prefix + `/resources/detail?pid=${this.pid}`).then(res => {
                ...
                this.min_old_price = res[0].data[0].min_old_price ? res[0].data[0].min_old_price : undefined
                for (let item of res[1].data) {
                    let tmp = { path: item.img_path }
                    // console.log(tmp)
